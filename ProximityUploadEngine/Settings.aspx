                    ...
                    <div class="card shadow Setting-Card" style="height: 100%;">
                        <div class="card-header">
                            <div class="row d-flex flex-column text-center">
                                ...
                                <div class="col">
                                    <button id="lbl_editProfile" class="btn rounded-pill">Edit Profile</button>
                                    <%--<asp:Button ID="lbl_editProfile" runat="server" Text="Edit Profile" CssClass="btn rounded-pill" Style="color: #ffffff; background-color: #004e92; max-width: 100%;" />--%>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
